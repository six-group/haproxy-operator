...
func (in *HTTPRequestRules) DeepCopyInto(out *HTTPRequestRules) {
	*out = *in
	...
	if in.ReplaceValue != nil {
		in, out := &in.ReplaceValue, &out.ReplaceValue
		*out = make([]ReplaceValue, len(*in))
		copy(*out, *in)
	}
	if in.Deny != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplaceValue) DeepCopyInto(out *ReplaceValue) {
	*out = *in
	out.Rule = in.Rule
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplaceValue.
func (in *ReplaceValue) DeepCopy() *ReplaceValue {
	if in == nil {
		return nil
	}
	out := new(ReplaceValue)
	in.DeepCopyInto(out)
	return out
}
