...
func (in *GlobalConfiguration) DeepCopyInto(out *GlobalConfiguration) {
	*out = *in
	...
	if in.TuneSslOptions != nil {
		in, out := &in.TuneSslOptions, &out.TuneSslOptions
		*out = new(GlobalTuneSSLOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.TuneBufferOptions != nil {
		in, out := &in.TuneBufferOptions, &out.TuneBufferOptions
		*out = new(GlobalTuneBufferOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.SSL != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlobalTuneBufferOptions) DeepCopyInto(out *GlobalTuneBufferOptions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalTuneBufferOptions.
func (in *GlobalTuneBufferOptions) DeepCopy() *GlobalTuneBufferOptions {
	if in == nil {
		return nil
	}
	out := new(GlobalTuneBufferOptions)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlobalTuneSSLOptions) DeepCopyInto(out *GlobalTuneSSLOptions) {
	*out = *in
	if in.CacheSize != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalTuneSSLOptions.
func (in *GlobalTuneSSLOptions) DeepCopy() *GlobalTuneSSLOptions {
	if in == nil {
		return nil
	}
	out := new(GlobalTuneSSLOptions)
